...
7- COMANDO MYSQL PARA CRIAR USUÁRIO DA APLICAÇÃO: CREATE USER IF NOT EXISTS 'financas_app'@'localhost' IDENTIFIED BY 'SuaSenhaForte123'; No lugar de SuaSenhaForte123 CRIE UMA SENHA PARA SUBSTITUIR. 
...
17- Digite sua senha neste trecho spring.datasource.password= SUA_SENHA_FINANCAS_APP                  APAGUE O SUA_SENHA_FINANCAS_APP 
18- Digite seu e-mail neste trecho spring.mail.username=DIGITE_SEU_E-MAIL                             APAGUE O DIGITE_SEU_E-MAIL 
19- No trecho: spring.mail.password= CRIE UMA SENHA ATRAVÉS DESSE LINK myaccount.google.com/apppasswords 
...
25- Insira o mvn spring-boot:run
